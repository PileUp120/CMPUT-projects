...
class GoBoard(object):
    ...
    def endOfGame(self):
        return((len(GoBoardUtil.generate_legal_moves(self.board, 'w')) == 0)
        or (len(GoBoardUtil.generate_legal_moves(self.board, 'b')) == 0))
    ...
    def play_move(self, point, color):
        ...
        #single_capture = self._detect_and_process_capture(point)
        #f single_capture != None:
        #    return (False, "capture")
        #self.ko_recapture = None
