...
class GtpConnection:
    ...
    def genmove_cmd(self, args):
        ...
        #at the start play random legal moves
        #when 1/3rd of the board is full, use minimax or negamax or ab minimax
        #when 2/3 of the board is full use pattern simulation
