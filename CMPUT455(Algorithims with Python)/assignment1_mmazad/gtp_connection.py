...
class GtpConnection:
    def __init__(self, go_engine, board, debug_mode=False):
        ...
        self.argmap = {
            ...
            #"gogui-rules_final_result":{0, "Usage: gogui_rules_final_result_cmd"},
            #"gogui-rules_legal_moves":{0, "Usage: gogui_rules_final_result_cmd"}
        }
    ...
    def gogui_rules_final_result_cmd(self, args):
        ...
        moves = GoBoardUtil.generate_legal_moves(self.board, board_color)
        op_color = GoBoardUtil.opponent(board_color)
        if(len(moves) == 0):
            if(op_color == WHITE):
                self.respond('white')
            else:
