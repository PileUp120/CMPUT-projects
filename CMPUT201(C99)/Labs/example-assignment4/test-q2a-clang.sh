...
bash ./question2-clang.sh <q2a-test3-input.txt >q2a-test3-output.txt
diff -b q2a-test3-output.txt q2a-test3-expected-output.txt

bash ./question2-clang.sh <q2a-test4-input.txt >q2a-test4-output.txt
diff -b q2a-test4-output.txt q2a-test4-expected-output.txt

bash ./question2-clang.sh <q2a-test5-input.txt >q2a-test5-output.txt
diff -b q2a-test5-output.txt q2a-test5-expected-output.txt

bash ./question2-clang.sh <q2a-test6-input.txt >q2a-test6-output.txt
